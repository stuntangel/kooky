{
  description = "Stunt's kooky GNU Emacs with sensible defaults";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        ...
        devShell = pkgs.mkShell {
          shellHook = ''
            echo "Entering the 'github:stuntangel/kooky' development environment"
    ...
    // {
      overlays.default = final: prev: {
        kooky = self.packages.${final.system}.default;
      };
    };
}
